...
+ (void)registerForNetworkReachabilityNotifications
{
	[[ASIHTTPReachability reachabilityForInternetConnection] startNotifier];
...
{
	return ([[ASIHTTPReachability reachabilityForInternetConnection] currentReachabilityStatus] == ReachableViaWWAN);	
}
